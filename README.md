...
**ES.** Invierte un DEM (los picos se vuelven fosas y los valles, crestas) y le da un estilo oscuro de terror retro. Tres formas de dar la vuelta: respecto a mínimo + máximo (mantiene el rango), respecto al nivel del mar (0 m) o respecto a una cota elegida. Si das la vuelta dos veces con los mismos ajustes, vuelves al DEM original.
